...
N <- 1200 #set a population size
fA <- 1/N #set a starting freqeuncy for allele A
...
evol.hap <- function(fA, gens, wA, wa){
...
genX <- evol.hap(fA,gens,wA,wa)
gen <- seq(1,gens,1)
plot(gen, genX, type='l', col='magenta', lwd=2, xlab='generation', ylab='frequency of allele A', main='Haploid Selection. wA=1.3 | wa=1.1')
